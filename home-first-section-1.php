    ...
    <?php
       $single = get_single_all_electronics_1();
       ...
       <div class="col-md-6">
        ...
        <div class="overlay item-title" style="background-image: url(<?php echo $singles["thumbnail"] ?>)">
            ...
            <div class="item-title-content">
                ...
                <span class="date" style="margin-left: 0px; color: white;" ><?php echo date("d/m/Y", strtotime($singles["date"])); ?></span>
                    <div class="fa fa-share-alt" title="Поделиться в соц. сетях"></div>
                    
                    <div class="likely likely-custom" data-url="path" data-media="<?php echo $singles["thumbnail"] ?>" data-title="Новые смартфоны покорили поклонников мобильной индустрии">
