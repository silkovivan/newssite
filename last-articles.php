<?php include_once("$_SERVER[DOCUMENT_ROOT]/db_for_last_articles.php"); ?>
...
<aside class="main-aside" style="height: auto !important;">
	...
	<?php
       $single = get_single_all_electronics_last_articles();
       foreach ($single as $singles): ?>
		...
		<?php
       $single = get_single_all_itnews_last_articles();
       foreach ($single as $singles): ?>
		...
		<?php
       $single = get_single_all_reviews_last_articles();
       foreach ($single as $singles): ?>
		...
		<?php
       $single = get_single_all_videocards_last_articles();
       foreach ($single as $singles): ?>
		...
		<?php
       $single = get_single_all_bitcoin_last_articles();
       foreach ($single as $singles): ?>
